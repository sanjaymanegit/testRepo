...
class TY_02_Ui_MainWindow_GASKET(object):
    def setupUi(self, MainWindow):
        ...
        font.setFamily("Arial")
        font.setPointSize(10)
        self.pushButton_4_6.setFont(font)       
        self.pushButton_4_6.setText("Set Sample")      
...
#         self.pushButton.setIconSize(QtCore.QSize(100, 80))
        ...
        #self.pushButton_4.setGeometry(QtCore.QRect(0, 0, 201, 281))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(22)
        font.setBold(True)
...
#         self.pushButton_4.setIconSize(QtCore.QSize(100, 80))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_37.setText(_translate("MainWindow", "Trvl.Dist(mm):   "))
        ...
        if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
                print("ok  11")
                self.tableWidget.setHorizontalHeaderLabels(['CS Area (Mm2)','Break Load \n (N)','Trvl.Dist \n (Mm)','Shape','Product Length \n (Mm)','Tensile Strength \n (MPa)','Mod@50% \n (MPa)','Mod@100% \n (MPa)','Mod@200% \n (MPa)','Trvl. Dist (Mm)','%Trvl. Dist','Cycle Id'])        
                self.label_35.setText("Break Load (N):")
                self.label_37.setText("Trvl.Dist(mm):   ")
                self.label_33.setText(" Force (N):   ")
                self.label_39.setText("Displacement (mm):")
        
        elif(self.last_load_unit == "Kg" and self.last_disp_unit=="Mm"):
                self.tableWidget.setHorizontalHeaderLabels(['CS Area (Cm2)','Break Load \n (Kgf)','Trvl.Dist \n (Cm)','Shape','Product Length \n (Mm)','Tensile Strength \n (Kgf/Cm2)','Mod@50% \n (Kgf/Cm2)','Mod@100% \n (Kgf/Cm2)','Mod@200% \n (Kgf/Cm2)','Trvl. Dist (Mm)','%Trvl. Dist','Cycle Id'])        
                self.label_35.setText("Break Load (Kgf):")
                self.label_37.setText("Trvl.Dist(mm):   ")
                self.label_33.setText(" Force (Kgf):   ")
                self.label_39.setText("Displacement (mm):")
        
        else:
                self.tableWidget.setHorizontalHeaderLabels(['CS Area ('+str(self.last_disp_unit)+')','Break Load \n ('+str(self.last_load_unit)+')','Trvl.Dist \n ('+str(self.last_disp_unit)+')','Shape','Product Length \n ('+str(self.last_disp_unit)+')','Tensile Strength \n ('+str(self.last_load_unit)+'/'+str(self.last_disp_unit)+'2)','Mod@50% \n ('+str(self.last_load_unit)+'/'+str(self.last_disp_unit)+'2)','Mod@100% \n ('+str(self.last_load_unit)+'/'+str(self.last_disp_unit)+'2)','Mod@200% \n ('+str(self.last_load_unit)+'/'+str(self.last_disp_unit)+'2)','Trvl. Dist','%Trvl. Dist','Cycle Id'])        
                self.label_35.setText("Break Load ("+str(self.last_load_unit)+"):")
                self.label_37.setText("Trvl.Dist("+str(self.last_disp_unit)+"):   ")
        ...
        self.pushButton_4_6.clicked.connect(self.open_set_sample)
...
#                     )
    ...
    def show_grid_data(self):
        ...
        if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
                    results=connection.execute("SELECT printf(\"%.4f\", CS_AREA),printf(\"%.2f\", PEAK_LOAD_N),printf(\"%.2f\", E_AT_PEAK_LOAD_MM),SHAPE,GUAGE100,printf(\"%.2f\", STG_TENSILE_STRENGTH_MPA) ,printf(\"%.2f\", MODULUS_50),printf(\"%.2f\", MODULUS_100),printf(\"%.2f\", MODULUS_200),printf(\"%.2f\", E_AT_PEAK_LOAD_MM),printf(\"%.2f\", PRC_E_AT_PEAK),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")
        elif(str(self.last_load_unit)=="Kg" and str(self.last_disp_unit)=="Mm"):
                    results=connection.execute("SELECT printf(\"%.4f\", CS_AREA*0.1),printf(\"%.2f\", PEAK_LOAD_KG),printf(\"%.2f\", E_AT_PEAK_LOAD_MM*0.1),SHAPE,GUAGE100,printf(\"%.2f\", TENSILE_STRENGTH) ,printf(\"%.2f\", MODULUS_50),printf(\"%.2f\", MODULUS_100),printf(\"%.2f\", MODULUS_200),printf(\"%.2f\", E_AT_PEAK_LOAD_MM),printf(\"%.2f\", PRC_E_AT_PEAK),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")
        else:
                    results=connection.execute("SELECT printf(\"%.4f\", CS_AREA),printf(\"%.2f\", PEAK_LOAD_KG),printf(\"%.2f\", E_AT_PEAK_LOAD_MM),SHAPE,GUAGE100,printf(\"%.2f\", TENSILE_STRENGTH) ,printf(\"%.2f\", MODULUS_50),printf(\"%.2f\", MODULUS_100),printf(\"%.2f\", MODULUS_200),printf(\"%.2f\", E_AT_PEAK_LOAD_MM*0.1),printf(\"%.2f\", PRC_E_AT_PEAK),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")
    ...
    def show_grid_data_guage_tensile(self):
        ...
        #self.tableWidget.setHorizontalHeaderLabels(['CS Area(mm2)', ' Break Load \n (Kgf) ', 'Trvl.Dist \n (mm)', 'Guage Length \n (mm)','Tensile Strength \n (Kgf/Cm2)','Mod@100% \n (Kgf/Cm2)','Mod@200% \n (Kgf/Cm2)','Mod@300% \n (Kgf/Cm2)','%Trvl. Dist','%E@Break','Yeild Strength \n (Kgf/Cm2)','E@Yeild Strength \n (Cm)','Cycle Id'])        
    ...
    def show_grid_data_compress(self):
        ...
        if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
              results=connection.execute("SELECT printf(\"%.4f\", CS_AREA),printf(\"%.2f\", PEAK_LOAD_N),printf(\"%.2f\", E_AT_BREAK_MM),printf(\"%.6f\", STG_TENSILE_STRENGTH_MPA) ,printf(\"%.2f\", GUAGE100),printf(\"%.2f\", PRC_E_AT_BREAK) ,datetime(CREATED_ON,'localtime'),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")
        else:
              results=connection.execute("SELECT printf(\"%.4f\", CS_AREA),printf(\"%.2f\", PEAK_LOAD_KG),printf(\"%.2f\", E_AT_BREAK_MM),printf(\"%.6f\", TENSILE_STRENGTH) ,printf(\"%.2f\", GUAGE100),printf(\"%.2f\", PRC_E_AT_BREAK) ,datetime(CREATED_ON,'localtime'),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")
        for row_number, row_data in enumerate(results):            
            self.tableWidget.insertRow(row_number)
            for column_number, data in enumerate(row_data):
                self.tableWidget.setItem(row_number,column_number,QTableWidgetItem(str(data)))                
    ...
    def show_grid_data_tear(self):
        ...
        #self.tableWidget.horizontalHeader().setStretchLastSection(True)
        if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
                self.tableWidget.setHorizontalHeaderLabels(['Thickness (mm)',' Peak Load (N) ','Tear Strength (N/Cm)','Created On','Cycle ID'])  
        else:
        ...
        connection = sqlite3.connect("tyr.db")
        if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
                results=connection.execute("SELECT printf(\"%.2f\", THINCKNESS),printf(\"%.2f\", PEAK_LOAD_N),printf(\"%.2f\",(round(PEAK_LOAD_N,2)/round(THINCKNESS,2)*10)),datetime(CREATED_ON,'localtime'),cycle_id FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID")     
        else:    
    ...
    def save_graph_data(self):                 
        ...
        if (len(self.sc_new.arr_p) > 1):
            ...
            with connection:        
              ...
              for g in range(len(self.sc_new.arr_p)-1):
                  if(self.test_type=="Compressx" or self.test_type=="Flexural"):
                        ...
                        if(self.guage_ext_flg=="Y"):
                                ...
                                #cursor.execute("INSERT INTO STG_GRAPH_MST(X_NUM,Y_NUM) VALUES ('"+str(float(self.sc_new.arr_p[g]))+"','"+str(self.sc_new.arr_q[g])+"')")
                                cursor.execute("INSERT INTO STG_GRAPH_MST(X_NUM,X_NUM_CM,X_NUM_INCH,Y_NUM,Y_NUM_N,Y_NUM_LB,Y_NUM_KN,Y_NUM_MPA) VALUES ('"+str(float(self.sc_new.arr_p[g]))+"','"+str(float(self.sc_new.arr_p_cm[g]))+"','"+str(float(self.sc_new.arr_p_inch[g]))+"','"+str(float(self.sc_new.arr_q[g]))+"','"+str(float(self.sc_new.arr_q_n[g]))+"','"+str(float(self.sc_new.arr_q_lb[g]))+"','"+str(float(self.sc_new.arr_q_kn[g]))+"','"+str(float(self.sc_new.arr_q_mpa[g]))+"')")
            ...
            for g in range(len(self.sc_new.arr_p)):                 
                 if((float(self.guage_length_mm)*0.5) <= float(self.sc_new.arr_p[g])):
                        self.load50_guage=float(self.sc_new.arr_q[g])
                        break; 
            for g in range(len(self.sc_new.arr_p)):                 
        ...
        if (len(self.sc_new.arr_p) > 1):
            ...
            with connection:
                  ...
                  #cursor.execute("UPDATE GLOBAL_VAR SET NEW_TEST_AREA=2*NEW_TEST_AREA")  
                  ...
                  cursor.execute("UPDATE GLOBAL_VAR SET STG_LOAD50_GUAGE='"+str(self.load50_guage)+"'")
                  ...
                  #print("ok5")
                  if(str(self.last_load_unit)=="MPa" and str(self.last_disp_unit)=="Mm"):
                          cursor.execute("UPDATE GLOBAL_VAR SET STG_MODULUS_50=((cast(STG_LOAD50_GUAGE as real) * 9.81)/ IFNULL(cast(NEW_TEST_AREA as real),1))") 
                          cursor.execute("UPDATE GLOBAL_VAR SET STG_MODULUS_100=((cast(STG_LOAD100_GUAGE as real) * 9.81)/ IFNULL(cast(NEW_TEST_AREA as real),1))") #Kg to Newton converted Load and mm (N/Mm2)
                          cursor.execute("UPDATE GLOBAL_VAR SET STG_MODULUS_200=((cast(STG_LOAD200_GUAGE as real) * 9.81)/ IFNULL(cast(NEW_TEST_AREA as real),1))")
                          cursor.execute("UPDATE GLOBAL_VAR SET STG_MODULUS_300=((cast(STG_LOAD300_GUAGE as real) * 9.81)/ IFNULL(cast(NEW_TEST_AREA as real),1))")
                  else:                                                        
                          cursor.execute("UPDATE GLOBAL_VAR SET STG_MODULUS_50=((cast(STG_LOAD50_GUAGE as real)/cast(NEW_TEST_AREA as real))*100)")
                  ...
                  if(self.test_type=="TENSILE_GASKET_SQUARE"):
                          cursor.execute("UPDATE CYCLES_MST SET PRC_E_AT_BREAK= (((E_AT_BREAK_MM)*100)/GUAGE100)*(2/3.14)  WHERE GRAPH_ID IS NULL")
                          cursor.execute("UPDATE CYCLES_MST SET PRC_E_AT_PEAK= (((E_AT_PEAK_LOAD_MM)*100)/GUAGE100)*(2/3.14)  WHERE GRAPH_ID IS NULL")                  
                  ...
                  #self.kgCm2_toMPA=float(0.0980665)
                  cursor.execute("UPDATE CYCLES_MST SET STG_TENSILE_STRENGTH_MPA=round((STG_TENSILE_STRENGTH_KG_CM*0.0980665),6) WHERE GRAPH_ID IS NULL") #STG_TENSILE_STRENGTH
    ...
    def create_pdf_tensile(self):
        ...
        if(self.last_load_unit == "MPa" and self.last_disp_unit=="Mm"):
                data= [['Spec. \n No.', 'CS.Area \n ('+str(self.last_disp_unit)+'2)','Break Load \n (N)' ,'Trvl. Dist \n ('+str(self.last_disp_unit)+')','% Trvl. Dist \n']]        
        elif(self.last_load_unit == "Kg" and self.last_disp_unit=="Mm"):
                data= [['Spec. \n No.', 'CS.Area (Cm2)','Break Load (Kg)' ,'Trvl. Dist (Cm)','% Trvl. Dist \n']]
        else:    
                data= [['Spec. \n No.', 'CS.Area \n ('+str(self.last_disp_unit)+'2)','Break Load \n ('+str(self.last_load_unit)+')' ,'Trvl. Dist \n ('+str(self.last_disp_unit)+')','% Trvl. Dist \n']]
        ...
        if(self.last_load_unit == "MPa" and self.last_disp_unit=="Mm"):
                ...
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT CYCLE_NUM,printf(\"%.4f\", CS_AREA),printf(\"%.2f\", PEAK_LOAD_N)  FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)")
                for x in results:
                        data.append(x)
                connection.close()        
                ...
                connection = sqlite3.connect("tyr.db")            
                results=connection.execute("SELECT 'AVG',printf(\"%.4f\", avg(CS_AREA)),printf(\"%.2f\", avg(PEAK_LOAD_N)),printf(\"%.2f\", avg(E_AT_PEAK_LOAD_MM)),printf(\"%.2f\", avg(PRC_E_AT_PEAK))  FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
                    
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MAX',printf(\"%.4f\", max(CS_AREA)),printf(\"%.2f\", max(PEAK_LOAD_N)),printf(\"%.2f\", max(E_AT_PEAK_LOAD_MM)),printf(\"%.2f\", max(PRC_E_AT_PEAK)) FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
                    
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MIN',printf(\"%.4f\", min(CS_AREA)),printf(\"%.2f\", min(PEAK_LOAD_N)),printf(\"%.2f\", min(E_AT_PEAK_LOAD_MM)),printf(\"%.2f\", min(PRC_E_AT_PEAK))  FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
                ...
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT CYCLE_NUM,printf(\"%.4f\", CS_AREA*0.01),printf(\"%.2f\", PEAK_LOAD_KG),printf(\"%.2f\", E_AT_PEAK_LOAD_MM*0.1),printf(\"%.2f\", PRC_E_AT_PEAK) FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)")
                for x in results:
                        data.append(x)
                connection.close()        
                ...
                connection = sqlite3.connect("tyr.db")            
                results=connection.execute("SELECT 'AVG',printf(\"%.4f\", avg(CS_AREA*0.01)),printf(\"%.2f\", avg(PEAK_LOAD_KG)),printf(\"%.2f\", avg(E_AT_PEAK_LOAD_MM*0.1)),printf(\"%.2f\", avg(PRC_E_AT_PEAK)) FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
                    
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MAX',printf(\"%.4f\", max(CS_AREA*0.01)),printf(\"%.2f\", max(PEAK_LOAD_KG)),printf(\"%.2f\", max(E_AT_PEAK_LOAD_MM*0.1)),printf(\"%.2f\", max(PRC_E_AT_PEAK)) FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
                    
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MIN',printf(\"%.4f\", min(CS_AREA*0.01)),printf(\"%.2f\", min(PEAK_LOAD_KG)),printf(\"%.2f\", min(E_AT_PEAK_LOAD_MM*0.1)),printf(\"%.2f\", min(PRC_E_AT_PEAK))  FROM CYCLES_MST WHERE TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1")
                for x in results:
                        data.append(x)
                connection.close()
        ...
        if(self.last_load_unit == "MPa" and self.last_disp_unit=="Mm"):
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select CYCLE_NUM,printf(\"%.2f\", A.STG_TENSILE_STRENGTH_N_MM),printf(\"%.2f\", A.MODULUS_50),printf(\"%.2f\", A.MODULUS_100),printf(\"%.2f\", A.MODULUS_200)   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID") 
                for x in results:
                    data2.append(x)
                connection.close()  
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'AVG' as SPECIMEN_NUM,printf(\"%.2f\", avg(A.STG_TENSILE_STRENGTH_N_MM)),printf(\"%.2f\", avg(A.MODULUS_50)),printf(\"%.2f\", avg(A.MODULUS_100)),printf(\"%.2f\", avg(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'MAX' as SPECIMEN_NUM,printf(\"%.2f\", max(A.STG_TENSILE_STRENGTH_N_MM)),printf(\"%.2f\", max(A.MODULUS_50)),printf(\"%.2f\", max(A.MODULUS_100)),printf(\"%.2f\", max(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'MIN' as SPECIMEN_NUM,printf(\"%.2f\", min(A.STG_TENSILE_STRENGTH_N_MM)),printf(\"%.2f\", min(A.MODULUS_50)),printf(\"%.2f\", min(A.MODULUS_100)),printf(\"%.2f\", min(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close() 
                ...
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select CYCLE_NUM,printf(\"%.2f\", A.TENSILE_STRENGTH),printf(\"%.2f\", A.MODULUS_50),printf(\"%.2f\", A.MODULUS_100),printf(\"%.2f\", A.MODULUS_200)  FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) order by GRAPH_ID") 
                for x in results:
                    data2.append(x)
                connection.close()  
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'AVG' as SPECIMEN_NUM,printf(\"%.2f\", avg(A.TENSILE_STRENGTH)),printf(\"%.2f\", avg(A.MODULUS_50)),printf(\"%.2f\", avg(A.MODULUS_100)),printf(\"%.2f\", avg(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'MAX' as SPECIMEN_NUM,printf(\"%.2f\", max(A.TENSILE_STRENGTH)),printf(\"%.2f\", max(A.MODULUS_50)),printf(\"%.2f\", max(A.MODULUS_100)),printf(\"%.2f\", max(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("select 'MIN' as SPECIMEN_NUM,printf(\"%.2f\", min(A.TENSILE_STRENGTH)),printf(\"%.2f\", min(A.MODULUS_50)),printf(\"%.2f\", min(A.MODULUS_100)),printf(\"%.2f\", min(A.MODULUS_200))   FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR) LIMIT 1") 
                for x in results:
                    data2.append(x)
                connection.close() 
    ...
    def create_pdf_compress(self):        
        ...
        if(self.last_load_unit == "MPa" and self.last_disp_unit=="Mm"):
             ...
             data2= [ ['Spec. \n No', 'CS Area \n ('+str(self.last_disp_unit)+')', 'Force at Peak\n ('+str(self.last_load_unit)+')', 'Compression \n ('+str(self.last_disp_unit)+')', 'Compressive Strength \n ('+str(self.last_load_unit)+'/'+str(self.last_disp_unit)+')',' % Compression \n']] 
            
        
        
        if(self.last_load_unit == "MPa" and self.last_disp_unit=="Mm"):
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT CYCLE_NUM,printf(\"%.4f\", A.CS_AREA),printf(\"%.2f\", A.PEAK_LOAD_N),printf(\"%.2f\", A.E_AT_BREAK_MM),printf(\"%.6f\", A.STG_TENSILE_STRENGTH_MPA),printf(\"%.2f\", A.PRC_E_AT_BREAK) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'AVG',printf(\"%.4f\", avg(A.CS_AREA)),printf(\"%.2f\", avg(A.PEAK_LOAD_N)),printf(\"%.2f\", avg(A.E_AT_BREAK_MM)),printf(\"%.6f\", avg(A.STG_TENSILE_STRENGTH_MPA)),printf(\"%.2f\", avg(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                ...
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MAX',printf(\"%.4f\", max(A.CS_AREA)),printf(\"%.2f\", max(A.PEAK_LOAD_N)),printf(\"%.2f\", max(A.E_AT_BREAK_MM)),printf(\"%.6f\", max(A.STG_TENSILE_STRENGTH_MPA)),printf(\"%.2f\", max(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MIN',printf(\"%.4f\", min(A.CS_AREA)),printf(\"%.2f\", min(A.PEAK_LOAD_N)),printf(\"%.2f\", min(A.E_AT_BREAK_MM)),printf(\"%.6f\", min(A.STG_TENSILE_STRENGTH_MPA)),printf(\"%.2f\", min(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
        else:
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT CYCLE_NUM,printf(\"%.4f\", A.CS_AREA),printf(\"%.2f\", A.PEAK_LOAD_KG),printf(\"%.2f\", A.E_AT_BREAK_MM),printf(\"%.6f\", A.TENSILE_STRENGTH),printf(\"%.2f\", A.PRC_E_AT_BREAK) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'AVG',printf(\"%.4f\", avg(A.CS_AREA)),printf(\"%.2f\", avg(A.PEAK_LOAD_KG)),printf(\"%.2f\", avg(A.E_AT_BREAK_MM)),printf(\"%.6f\", avg(A.TENSILE_STRENGTH)),printf(\"%.2f\", avg(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                ...
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MAX',printf(\"%.4f\", max(A.CS_AREA)),printf(\"%.2f\", max(A.PEAK_LOAD_KG)),printf(\"%.2f\", max(A.E_AT_BREAK_MM)),printf(\"%.6f\", max(A.TENSILE_STRENGTH)),printf(\"%.2f\", max(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
                connection = sqlite3.connect("tyr.db")
                results=connection.execute("SELECT 'MIN',printf(\"%.4f\", min(A.CS_AREA)),printf(\"%.2f\", min(A.PEAK_LOAD_KG)),printf(\"%.2f\", min(A.E_AT_BREAK_MM)),printf(\"%.6f\", min(A.TENSILE_STRENGTH)),printf(\"%.2f\", min(A.PRC_E_AT_BREAK)) FROM  CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
                for x in results:
                        data2.append(x)
                connection.close()
    ...
    def open_pdf(self):
        ...
        for x in results:
                    ...
                    elif(str(x[0]) == "TENSILE_GASKET_ROUND"):
                        self.create_pdf_tensile()
                    elif(str(x[0]) == "TENSILE_GASKET_SQUARE"):
                        self.create_pdf_tensile()
                    else:
