...
class TY_35_IDF_LIST_Ui_MainWindow(object):
...
#         self.kgCm2_toMPA=float(0.0980665)
    ...
    def list_tests(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Test ID.','CreatedOn','Customer Name','Def.Points','Batch ID.','Comments'])
...
if __name__ == "__main__":
    ...
    ui = TY_35_IDF_LIST_Ui_MainWindow()
