...
#from print_test_popup2 import PrintDemo
import sqlite3
...
"border-width:4px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.pushButton_7.clicked.connect(self.print_DEMO)
        self.pushButton_7.clicked.connect(self.onPrint)
        self.load_data()
    ...
    def printDialog(self):        
        ...
        #filePath, filter =QFileDialog.getOpenFileName(self, 'Open file', '')
        ...
        if file_extension == ".pdf":
            ...
            #dialogx = QPrintDialog(printer, self)
            dialog = QPrintDialog(printer)
            if dialog.exec_() == QPrintDialog.Accepted:
                print("accepted ok ..")
                with tempfile.TemporaryDirectory() as path:
                    print("File Path  :"+str(filePath)+"   Temp Path"+str(tempfile.TemporaryDirectory()))
