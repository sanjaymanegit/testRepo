    ...
    def startx(self):
        ...
        for x in results:            
                 ...
                 if(self.label_2.text() == 'DATE_RANGE'):
                     ...
                     self.whr_sql2=" WHERE  BATCH_ISSUE_FLG='SELL' AND IFNULL(SECOND_WT_CREATED_ON,FIRST_WT_CRTEATED_ON)  between '"+str(x[2])+"' and '"+str(x[3])+"' order by serial_id,CURR_TRUCK_CNT limit 400"
