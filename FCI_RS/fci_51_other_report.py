...
class fci_51_Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Weighing Records Report as on "+datetime.datetime.now().strftime("%d %b %Y")))
    ...
    def startx(self):
        ...
        for x in results:            
                 ...
                 if(self.label_2.text() == 'DATE_RANGE'):
                     ...
                     self.whr_sql2=" WHERE  BATCH_ISSUE_FLG='WEIGHING' AND IFNULL(SECOND_WT_CREATED_ON,FIRST_WT_CRTEATED_ON)  between '"+str(x[2])+"' and '"+str(x[3])+"' order by serial_id,CURR_TRUCK_CNT limit 400"
