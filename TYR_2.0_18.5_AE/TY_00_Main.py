...
# Form implementation generated from reading ui file 'TY_00_Main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3_1.setGeometry(QtCore.QRect(730, 50, 400, 171))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_3_1.setFont(font)
        self.pushButton_3_1.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./images/logo_AE.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
