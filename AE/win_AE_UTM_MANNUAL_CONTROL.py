...
class  AE_MANUAL_CONTROL_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1.addPixmap(QtGui.QPixmap("./images/down.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def down_run(self): ## Down Direction
        if(str(self.lineEdit.text()) == ""):
                    ...
                    try:
                            ...
                            self.instrument = minimalmodbus.Instrument('COM1', 7) # port name, slave address (in decimal)
