...
class fci_30_Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "Batch_ID"))
        self.treeWidget.headerItem().setText(1, _translate("MainWindow", "Vehicle_ ID"))
        self.treeWidget.headerItem().setText(2, _translate("MainWindow", "No.Of.Bags"))
        self.treeWidget.headerItem().setText(3, _translate("MainWindow", "Net.Wt.Tone"))
        self.treeWidget.headerItem().setText(4, _translate("MainWindow", "Slip.No."))
        self.treeWidget.headerItem().setText(5, _translate("MainWindow", "Unloaded On"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "R0001"))
        self.treeWidget.topLevelItem(0).setText(1, _translate("MainWindow", "fdgdfgdfgfd"))
        self.treeWidget.topLevelItem(0).setText(2, _translate("MainWindow", "fdgfdgfdg"))
        self.treeWidget.topLevelItem(0).setText(3, _translate("MainWindow", "fdgdfgfdg"))
        self.treeWidget.topLevelItem(0).setText(4, _translate("MainWindow", "dfgfdgf"))
        self.treeWidget.topLevelItem(0).setText(5, _translate("MainWindow", "fdgfdg"))
