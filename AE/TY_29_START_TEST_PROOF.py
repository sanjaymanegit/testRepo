...
"")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(660, 260, 641, 201))
        font = QtGui.QFont()
        font.setFamily("Arial")
...
"color: rgb(255, 0, 0);")
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(1210, 480, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
...
#                self.gridLayout.addWidget(self.sc_blank, 1, 0, 1, 1)
    ...
    def create_pdf_PROOF(self):
        ...
        for x in results:
            summary_data=[["Tested Date: ",str(x[10]),"Test No: ",str(x[0])],["Job Name : ",str(x[1]),"Batch ID: ",str(x[2])],["Specimen Name:  ",str(x[4]),"Specmen Shape:",str(x[9])],["Test Type:",str(x[3]),"Specmen Specs:",str(x[8])],["Party Name :",str(x[7]),"Test Speed (mm/min) :",str(x[5])],["Guage Length(mm):",str(x[6]),"Report Date: ",str(x[11])],["Tested By :", "","",""]]
