...
# Form implementation generated from reading ui file 'wt_21_ser_DAT.ui'
#
...
class wt_21_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(430, 40, 221, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
...
"color: rgb(170, 0, 0);")
        ...
        self.groupBox.setGeometry(QtCore.QRect(230, 100, 631, 131))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
...
"color: rgb(170, 0, 0);")
        ...
        self.line.setGeometry(QtCore.QRect(110, 250, 871, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.groupBox_2 = QtWidgets.QGroupBox(self.frame)
        self.groupBox_2.setGeometry(QtCore.QRect(80, 280, 931, 291))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(130, 80, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_4.setFont(font)
        self.pushButton_4.setObjectName("pushButton_4")
        self.calendarWidget = QtWidgets.QCalendarWidget(self.groupBox_2)
        self.calendarWidget.setGeometry(QtCore.QRect(600, 50, 296, 183))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(290, 80, 221, 41))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(220, 180, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_5.setFont(font)
        self.pushButton_5.setObjectName("pushButton_5")
        self.pushButton_6 = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_6.setGeometry(QtCore.QRect(380, 180, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_19.setText(_translate("MainWindow", "DAT Setting"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "DAT Setting"))
        self.pushButton_4.setText(_translate("MainWindow", "Set Date"))
        self.pushButton_5.setText(_translate("MainWindow", "Set  DAT- Date"))
    ...
    def login_page(self):
        ...
        results=connection.execute("SELECT PWD,xxx FROM SERVICES_MST WHERE SERVICE_NAME = 'DAT' AND STATUS = 'ACTIVE'") 
        for x in results:
            print("key:"+str(x[1]))
            key=str(x[1])
            val=str(x[0])
    ...
    def date_dd_click(self):        
        ...
        self.lineEdit_2.setText(self.from_date)
        self.calendarWidget.hide()
    ...
    def save_data(self):              
        ...
        with connection:        
                ...
                cursor.execute("UPDATE DAT_MST SET DAT_STR = '"+str(self.lineEdit_2.text())+"'") 
        connection.commit();
        connection.close()
