...
from TY_31_REPORT_PROOF import ty_31_Ui_MainWindow
...
class TY_30_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 20, 1331, 709))
        font = QtGui.QFont()
...
"color: rgb(0, 0, 0);")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 160, 1301, 538))
        font = QtGui.QFont()
        font.setFamily("Arial")
...
"color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        #self.comboBox_5.addItem("")
        self.comboBox_5.setItemText(0, _translate("MainWindow", "Kgf/mm"))
    ...
    def startx(self):
        ...
        results=connection.execute("SELECT DISTINCT PARTY_NAME FROM TEST_MST WHERE TEST_TYPE='PROOF'") 
        for x in results:            
            self.comboBox_3.addItem("")
    ...
    def onchage_party(self):
        ...
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT DISTINCT BATCH_ID FROM TEST_MST where  TEST_TYPE='PROOF' and PARTY_NAME='"+self.comboBox_3.currentText()+"'") 
        for x in results:            
    ...
    def select_all_tests(self):
        ...
        results=connection.execute("SELECT B.TEST_ID,B.CREATED_ON,B.SPECIMEN_NAME,B.BATCH_ID,B.PARTY_NAME,B.TEST_TYPE FROM TEST_MST B where B.CREATED_ON between '"+str(self.from_dt)+"' and '"+str(self.to_dt)+"' and TEST_TYPE ='PROOF'")                        
        ...
        with connection:        
                ...
                cursor.execute("INSERT INTO TEST_IDS SELECT B.TEST_ID,B.TEST_TYPE  FROM TEST_MST B  where B.CREATED_ON between '"+str(self.from_dt)+"' and '"+str(self.to_dt)+"' and SPECIMEN_NAME='PROOF'") 
        connection.commit();
        connection.close()
