...
class def_07_Ui_MainWindow(object):
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_8.clicked.connect(self.set_zero)
    ...
    def load_data(self):       
        ...
        results=connection.execute("SELECT LD_SET,(CAPACITY_SET*1000),OFF_POSITION_SET,FLAG_SET,K_FACTOR,LAST_CALIBRATION_DT FROM GLOBAL_VAR_TEST  ") 
        for x in results:
               self.ld_set=str(x[0])
               self.wt_min_limit=str(x[2])
               self.wt_max_limit=str(x[1])               
    ...
    def ld_set_fun(self):
        ...
        with connection:        
                    ...
                    cursor.execute("UPDATE GLOBAL_VAR_TEST SET LD_SET='"+self.comboBox_2.currentText()+"'")                    
        connection.commit();                    
        connection.close()
    ...
    def capacity_set(self):
        ...
        with connection:        
                    cursor = connection.cursor()
                    cursor.execute("UPDATE GLOBAL_VAR_TEST SET CAPACITY_SET='"+self.comboBox.currentText()+"'")                    
        connection.commit();                    
        connection.close()
    ...
    def off_position_set(self):
        ...
        with connection:        
                    cursor = connection.cursor()
                    cursor.execute("UPDATE GLOBAL_VAR_TEST SET OFF_POSITION_SET='"+self.comboBox_3.currentText()+"'")                    
        connection.commit();                    
        connection.close()
    ...
    def flag_set(self):        
        ...
        with connection:        
                    cursor = connection.cursor()
                    cursor.execute("UPDATE GLOBAL_VAR_TEST SET FLAG_SET='"+self.flag+"'")                    
        connection.commit();                    
        connection.close()
    ...
    def start_calibration(self):
        if(self.lineEdit.text() != ""):            
            ...
            with connection:        
                    cursor = connection.cursor()
                    cursor.execute("UPDATE GLOBAL_VAR_TEST SET CALIBRATION_LOAD_SET='"+self.lineEdit.text()+"'")                    
            connection.commit();                    
            connection.close()
            ...
            try:
                ...
                if(int(self.c_wt) > 0):
                    ...
                    with connection:        
                            cursor = connection.cursor()
                            cursor.execute("UPDATE GLOBAL_VAR_TEST SET K_FACTOR='"+str(self.k_factor)+"',LAST_CALIBRATION_DT='"+str(self.label_20.text())+"',C2_COUNT='"+str(self.count_value)+"'")                    
                            cursor.execute("UPDATE GLOBAL_VAR_TEST SET K_FACTOR=((C2_COUNT-C1_COUNT)/CALIBRATION_LOAD_SET)")
                            cursor.execute("UPDATE GLOBAL_VAR_TEST SET K_FACTOR=(K_FACTOR*(-1)) WHERE K_FACTOR < 0")  
