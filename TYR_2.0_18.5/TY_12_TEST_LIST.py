...
"color: rgb(255, 255, 255);")
    ...
    def save_test_IFD(self):                     
        ...
        connection.commit();
        connection.close()
        self.open_new_window_IFD()
    
    def open_new_window_IFD(self):                
        self.window = QtWidgets.QMainWindow()
        self.ui=TY_75_Ui_MainWindow()
        self.ui.setupUi(self.window)           
        self.window.show()
    ...
    def save_test_adhesion_strength(self):                     
        ...
        connection.commit();
        connection.close()
        self.open_new_window_adhesion_strength()
        
    def open_new_window_adhesion_strength(self):                
        self.window = QtWidgets.QMainWindow()
        self.ui=TY_69_Ui_MainWindow()
        self.ui.setupUi(self.window)           
        self.window.show()
    ...
    def save_test_tear_strength(self):                     
        ...
        connection.commit();
        connection.close()
        self.open_new_window_tear_strength()
        
    def open_new_window_tear_strength(self):                
        self.window = QtWidgets.QMainWindow()
        self.ui=TY_67_Ui_MainWindow()
        self.ui.setupUi(self.window)           
        self.window.show()
    ...
    def save_test_compress_3(self):                     
        ...
        connection.commit();
        connection.close()
        self.open_new_window_compression_3()
    ...
    def save_test_pull_on_force_test(self):                     
        connection = sqlite3.connect("tyr.db")              
        with connection:        
                    cursor = connection.cursor()
    ...
    def save_test_push_on_force_test(self):                     
        connection = sqlite3.connect("tyr.db")              
        with connection:        
                    cursor = connection.cursor()
    ...
    def open_new_window_pull_on_force(self):                
        self.window = QtWidgets.QMainWindow()
        self.ui=TY_51_Ui_MainWindow()
        self.ui.setupUi(self.window)           
        self.window.show()
    
    def open_new_window_push_on_force(self):                
        self.window = QtWidgets.QMainWindow()
        self.ui=TY_53_Ui_MainWindow()
        self.ui.setupUi(self.window)           
        self.window.show()
