...
class TY_71_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_10.setGeometry(QtCore.QRect(500, 190, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(1170, 130, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
...
"background-color: rgb(0, 0, 0);")
        ...
        self.radioButton.setGeometry(QtCore.QRect(690, 20, 101, 31))
...
"border-width:4px;")
        ...
        self.line_3.setGeometry(QtCore.QRect(480, 0, 20, 251))
...
#         self.comboBox_2.addItem("")
        ...
        self.line_7.setGeometry(QtCore.QRect(1130, 0, 20, 251))
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(1010, 190, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
...
"border-width:4px;")
        ...
        self.label_37.setGeometry(QtCore.QRect(10, 70, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.line_5.setGeometry(QtCore.QRect(490, 110, 501, 21))
        self.line_5.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_5.setLineWidth(3)
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setObjectName("line_5")
        self.label_50 = QtWidgets.QLabel(self.frame)
        self.label_50.setGeometry(QtCore.QRect(1150, 70, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_23.setGeometry(QtCore.QRect(500, 140, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.lineEdit_10.setGeometry(QtCore.QRect(630, 140, 61, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_24.setGeometry(QtCore.QRect(700, 140, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_26.setGeometry(QtCore.QRect(940, 140, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_27.setGeometry(QtCore.QRect(700, 190, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_17.setGeometry(QtCore.QRect(10, 120, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.pushButton_17.setStyleSheet("background-color: rgb(169, 202, 255);\n"
"border-radius:20px;\n"
"border-color: rgb(0, 0, 0);\n"
"border-style:outset;\n"
"border-width:4px;")
        ...
        self.label_25.setGeometry(QtCore.QRect(740, 140, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "CLD3"))
        ...
        item.setText(_translate("MainWindow", "Load @ Guage_1  (Kg)"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Load @ Guage_2  (Kg)"))
...
#         self.comboBox_2.setItemText(4, _translate("MainWindow", "Lb"))
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Load @ '+str(self.lineEdit_11.text())+' mm Guage\n ('+str(self.comboBox_2.currentText())+')','cycle_id'])        
...
#         self.sc_new.save_data_flg=""
    ...
    def show_grid_data_Tear(self):
        ...
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT printf(\"%.2f\", LOAD_POINT_2),cycle_id FROM CYCLES_MST WHERE TEST_ID = '"+self.test_id+"' order by GRAPH_ID")
    ...
    def create_pdf_Tear(self):
        ...
        data2= [ ['Spec. \n No', 'Load @ '+str(self.disp_2)+' mm\n ('+str(self.last_load_unit)+')']]
        
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT CYCLE_NUM,printf(\"%.2f\", A.LOAD_POINT_2) FROM CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
        for x in results:
                data2.append(x)
        connection.close()
        
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT 'AVG',printf(\"%.2f\", avg(A.LOAD_POINT_2)) FROM CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
        for x in results:
                data2.append(x)
        connection.close()
        
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT 'MAX',printf(\"%.2f\", max(A.LOAD_POINT_2)) FROM CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
        for x in results:
                data2.append(x)
        connection.close()
        
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("SELECT 'MIN',printf(\"%.2f\", min(A.LOAD_POINT_2)) FROM CYCLES_MST A WHERE A.TEST_ID IN (SELECT TEST_ID FROM GLOBAL_VAR)") 
        for x in results:
                data2.append(x)
        connection.close()
