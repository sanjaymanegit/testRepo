...
class TY_05_SPECI_5_ui_MainWindow(object):
...
"background-color: rgb(226, 239, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Specimen GASKET(5)"))
        ...
        self.lineEdit_7.setText(_translate("MainWindow", "Customer Name"))
        self.label_31.setText(_translate("MainWindow", "Pre. Load:"))
        self.label_33.setText(_translate("MainWindow", "Customer Name:"))
        ...
        self.comboBox_2.setItemText(1, _translate("MainWindow", "Cylindrical"))
    ...
    def c_fetch_data_from_tw(self):
        ...
        if(row != -1 ):
            ...
            self.lineEdit_7.setText(str(self.tableWidget.item(row, 3).text())) #Customer Name
    ...
    def validations(self):        
        ...
        if(self.lineEdit_12.text() == ""):
             ...
             self.label_21.setText("Customer Name is Empty.")
             self.label_21.show()
...
#         font.setWeight(75)        
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Spec.Id.','Product Name', 'Shape',' Customer Name ','Test Method','Test Speed',' Product Length  ','Pre Load','Thickness','Width','Inner Diameter','Outer Diameter','Diameter ','CS Area','Rev.Test Speed','Load Cell','Test Mode','Length Device'] )       
           
        connection = sqlite3.connect("tyr.db")
        results=connection.execute("select SPECIMEN_ID ,SPECIMEN_NAME ,SHAPE,PARTY_NAME ,SPECIMEN_SPECS,MOTOR_SPEED,GUAGE_LENGTH_MM ,PRE_LOAD ,THICKNESS, WIDTH , IN_DIAMETER_MM ,OUTER_DIAMETER_MM, DIAMETER ,C_A_AREA,REV_MOTOR_SPEED,LOAD_CELL,TEST_MODE,LENGTH_DEVICE  FROM SPECIMEN_MST where SHAPE in ('Rectangle','Cylindrical')")                        
...
if __name__ == "__main__":
    ...
    ui = TY_05_SPECI_5_ui_MainWindow()
