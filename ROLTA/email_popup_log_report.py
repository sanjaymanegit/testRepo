...
class popup_email_log_Ui_MainWindow(object):
...
"")
    ...
    def load_data(self):
        ...
        for x in results:
            ...
            self.lineEdit_3.setText("Report_of_log_"+str(x[3]).zfill(4)+".pdf")
            self.lineEdit_3.setDisabled(True)
            self.label_2.setText("Current Test ID is : "+str(x[3]))
            os.system("cp ./reports/log_report.pdf ./reports/Report_of_log_"+str(x[3]).zfill(4)+".pdf")
            self.filename="Report_of_log_"+str(x[3]).zfill(4)+".pdf"
        connection.close()
...
if __name__ == "__main__":
    ...
    ui = popup_email_log_Ui_MainWindow()
