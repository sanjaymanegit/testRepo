...
class urmini_17_Ui_MainWindow(object):
...
"color: rgb(0, 0, 0);")
    ...
    def load_data(self):
        ...
        results=connection.execute("SELECT SERVICE_NAME FROM SERVICES_MST WHERE STATUS = 'ACTIVE' and SERVICE_NAME = 'SYSTEM'") 
        for x in results:            
        ...
        if(self.lineEdit.text() != ""):
            if(self.lineEdit_2.text() != ""):
                if(self.lineEdit_2.text() == self.lineEdit.text()):
                    ...
                    connection.commit();
                    connection.close()
                    self.label_2.setText("Password Saved.") 
                    self.label_2.show()   
                else:
                    self.label_2.setText("Both Password should be same.") 
                    self.label_2.show()
            else:
                self.label_2.setText("ReType Pwd should not empty.") 
                self.label_2.show()    
        else:
           self.label_2.setText("New Pwd should not empty.") 
           self.label_2.show()     
