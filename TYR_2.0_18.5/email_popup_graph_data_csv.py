...
class popup_email_csv_Ui_MainWindow(object):
...
"")
    ...
    def load_data(self):
        ...
        results=connection.execute("SELECT EMAIL_DEFAULT,EMAIL_SUBJECT,EMAIL_CSV_FILE_NAME,EMAIL_TEST_ID FROM GLOBAL_VAR") 
        for x in results:
            ...
            self.filename=(str(x[2]))
            self.label_2.setText("Current Test ID is : "+str(x[3]))
            #os.system("cp ./reports/test_reports.pdf ./reports/"+str(self.filename))            
        connection.close()
                   ...
                   if(len(self.matched_token) > 0):
                       ...
                       if(str(self.lineEdit_2.text()) != ""):
                           ...
                           if(str(self.lineEdit_3.text()) != ""):
                                ...
                                self.matched_token = re.findall("\.csv", self.match_txt)
                                if(len(self.matched_token) == 1):
                                       self.validation_flg="TRUE"
                                else:
                                       self.validation_flg="FALSE"
                                       self.label_2.setText("Invalid File Name[.csv].")
...
if __name__ == "__main__":
    ...
    ui = popup_email_csv_Ui_MainWindow()
