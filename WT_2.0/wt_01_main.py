...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        #icon4.addPixmap(QtGui.QPixmap("wb2.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon4.addPixmap(QtGui.QPixmap("comp_name.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_5.setIcon(icon4)
        #self.pushButton_5.setIconSize(QtCore.QSize(801, 261))
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(860, 600, 90, 26))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(8)        
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(960, 600, 90, 26))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(8)        
        ...
        self.label_4_1.setGeometry(QtCore.QRect(1050, 600, 161, 26))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(8)
        #font.setBold(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.clicked.connect(self.open_new_window5)
