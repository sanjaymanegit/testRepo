...
class TY_01_T8_Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_21_1.setText(_translate("MainWindow", "Max .Stress ( MPa ):"))
        self.label_22_1.setText(_translate("MainWindow", "Max. Srtain ( % ):"))
    ...
    def load_data(self):
        ...
        self.label_3.setText("Tensile-Material Testing")
        self.test_type=str('Tensile')
        ...
        if(self.test_type=="Tear" or self.test_type=="Flexural"):
            ...
            results=connection.execute("SELECT SPECIMEN_NAME FROM SPECIMEN_MST where  SHAPE in ('Rectangle','Cylindrical')") 
        for x in results:            
            self.comboBox.addItem("")
