...
from TY_02_START_TEST_ILSS import TY_02_ilss_Ui_MainWindow
import sqlite3
from PyQt5.QtCore import QRegExp
from PyQt5.QtGui import QRegExpValidator

class TY_01_ilss_Ui_MainWindow(object):
    ...
    def load_data(self):
        ...
        results=connection.execute("SELECT NEW_TEST_NAME,SPAN FROM GLOBAL_VAR")
        ...
        if(str(rows[0][0])=="Compress"):
            ...
            self.label_1_1.show()
            self.lineEdit_1_1.setText(rows[0][1])
            self.lineEdit_1_1.show()
        elif(str(rows[0][0])=="ILSS"):
            self.label_1_1.setText("Span (mm) :")
            self.label_1_1.show()
            self.lineEdit_1_1.setText(rows[0][1])
            self.lineEdit_1_1.show()
        ...
        self.i=0
        connection = sqlite3.connect("tyr.db")
        if(self.test_type=="Tear" or self.test_type=="Flexural" or  self.test_type=="QLSS" or  self.test_type=="ILSS"  ):
        ...
        if (self.lineEdit.text() == ""):
            ...
            self.label_23.show()   
                ...
                if(self.lineEdit_2_1.text() == ""):
                    ...
                    self.goAhead="Yes"        
        elif(self.test_type=='Flexural' or self.test_type=='ILSS'):
