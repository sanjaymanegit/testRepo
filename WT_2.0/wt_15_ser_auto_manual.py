...
"color: rgb(170, 0, 0);")
        ...
        self.radioButton.setGeometry(QtCore.QRect(250, 70, 141, 41))
        self.radioButton.setChecked(True)
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioButton_2.setGeometry(QtCore.QRect(570, 70, 141, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton.setText(_translate("MainWindow", "Auto Only (default)"))
        self.radioButton_2.setText(_translate("MainWindow", "Mannual and Auto (Both)"))
    ...
    def login_page(self):
        ...
        results=connection.execute("SELECT PWD,xxx FROM SERVICES_MST WHERE SERVICE_NAME = 'AUTO_MANNUAL_SETTING' AND STATUS = 'ACTIVE'") 
        for x in results:
            print("key:"+str(x[1]))
            key=str(x[1])
            val=str(x[0])
    ...
    def save_data(self):        
        ...
        if(self.radioButton_2.isChecked()):
            self.auto_flag='MANNUAL_AND_AUTO'
