...
class wt_27_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1187, 661)
...
"color: rgb(170, 0, 0);")
    ...
    def save_sms_dtls(self):
        ...
        with connection:        
                ...
                cursor.execute("UPDATE USER_RIGHT_SET SET SMS_ACTIVATION='"+self.activation+"', SMS_API_KEY='"+self.lineEdit_2.text()+"', SMS_API_URL='"+str(self.lineEdit_4.text())+"'")
        connection.commit();
        connection.close()
