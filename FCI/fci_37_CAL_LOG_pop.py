...
class fci_37_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(30, 30, 711, 328))
        '''
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText("Calibration Log as on "+str(datetime.datetime.now().strftime("%d %b %Y %H:%M")))
