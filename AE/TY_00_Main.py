...
class Ui_00_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3_1.setText("Asian Test Equipments")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./images/AE_LOGO.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_3_1.setIcon(icon2)
        self.pushButton_3_1.setIconSize(QtCore.QSize(300, 300))
