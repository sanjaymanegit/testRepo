...
class change_pwd_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(30, 30, 1321, 705))
...
"color: rgb(170, 0, 0);")
    ...
    def login_page(self):        
        ...
        results=connection.execute("SELECT PWD,xxx FROM SERVICES_MST WHERE SERVICE_NAME = 'CHANGE_PASSWORDS' AND STATUS = 'ACTIVE'") 
        for x in results:
            val=str(x[0])
            '''
            #print("key:"+str(x[1]))
        ...
        if(self.lineEdit_2.text() != ""):
            if(self.lineEdit_3.text() != ""):
                if(self.lineEdit_2.text() == self.lineEdit_3.text()):
                    ...
                    b = bytes(str(self.lineEdit_2.text()), 'utf-8')
                    ...
                    with connection:        
                        ...
                        cursor.execute("UPDATE SERVICES_MST SET PWD = '"+str(self.lineEdit_2.text())+"', xxx='"+str(key,'utf-8')+"' WHERE SERVICE_NAME = '"+self.comboBox.currentText()+"' ") 
                    connection.commit();
                    connection.close()
