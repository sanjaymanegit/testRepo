    ...
    def validations(self):
        ...
        if(self.go_ahead=="Yes"): 
                ...
                if(self.test_id_exist=="Yes"):                   
                        ...
                        with connection:        
                                cursor = connection.cursor()                                                
                                cursor.execute("INSERT INTO TEST_MST(TEST_ID,TEST_TYPE,SPECIMEN_NAME,JOB_NAME,BATCH_ID,MOTOR_SPEED,MOTOR_REV_SPEED,OPERATOR,GRAPH_SCAL_Y_LOAD,GRAPH_SCAL_X_LENGTH,LOAD_POINTS,PARTY_NAME,NEW_TEST_MAX_LOAD,NEW_TEST_MAX_LENGTH) VALUES('"+str(int(self.label_12.text()))+"','RADIAL_TEST', '"+str(self.comboBox_4.currentText())+"', '"+str(self.lineEdit_15.text())+"', '"+str(self.lineEdit_16.text())+"', '"+str(self.lineEdit_9.text())+"','"+str(self.lineEdit_10.text())+"', '"+str(self.lineEdit_12.text())+"', '"+self.lineEdit_14.text()+"', '"+self.lineEdit_13.text()+"','"+str(self.comboBox.currentText())+"','RADIAL_TEST_PARTY','"+str(self.lineEdit_17.text())+"','"+str(self.lineEdit_18.text())+"')")
