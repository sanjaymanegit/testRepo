...
class wt_33_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setGeometry(QtCore.QRect(20, 20, 1191, 611))
    ...
    def login_page(self):
        ...
        for x in results:
            ...
            if(str(self.lineEdit_2.text()) == str(plain_text,'utf-8')):
