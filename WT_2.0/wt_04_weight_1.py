...
"color: rgb(255, 0, 0);")
        ...
        self.lineEdit_12.setGeometry(QtCore.QRect(180, 580, 95, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.lineEdit_12_1.setGeometry(QtCore.QRect(280, 580, 95, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.lineEdit_12_2.setGeometry(QtCore.QRect(380, 580, 95, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.lineEdit_17.setGeometry(QtCore.QRect(1120, 191, 145, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.lineEdit_16.setGeometry(QtCore.QRect(1120, 81, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        ...
        self.label_54 = QtWidgets.QCheckBox(self.frame)
        
        self.label_54.setGeometry(QtCore.QRect(1060, 160, 101, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
        font.setBold(True)
...
"color: rgb(170, 0, 0);")
        ...
        self.checkBox.setGeometry(QtCore.QRect(650, 275, 111, 31))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_41.setText(_translate("MainWindow", "Vehicle-Type:"))
        ...
        self.label_21.setText(_translate("MainWindow", "Transport Name:"))
        ...
        self.label_19.setText(_translate("MainWindow", "Regular Weighing"))
        #self.label_19.setText(_translate("MainWindow", "SR.No : 00122"))
        ...
        self.label_51.setText(_translate("MainWindow", "Avg.Wt Per Bag (Kg) :"))
        self.label_52.setText(_translate("MainWindow", "Total Bags :"))
        self.label_53.setText(_translate("MainWindow", "0"))
        self.label_47.setText(_translate("MainWindow", "Total Bags :"))
        self.label_49.setText(_translate("MainWindow", "0"))
        self.label_48.setText(_translate("MainWindow", "Avg.Wt Per Bag (Kg) :"))
        ...
        self.pushButton_7_1.setText(_translate("MainWindow", "View Pdf"))
        ...
        self.lineEdit_16.textChanged.connect(self.ontext_change)
        self.lineEdit_17.textChanged.connect(self.ontext_change2)
        self.label_45.hide()
        self.label_46.hide()
    ...
    def mannual_onclick(self):
        print("self.wt_type :"+str(self.wt_type))
    ...
    def set_disable_inputs(self):
        #print("Inside cjeck box fun ")
        if (self.label_54.isChecked()):
            self.lineEdit_16.setDisabled(True)
    ...
    def ontext_change(self):
        if(self.lineEdit_16.text() != ""):
            self.net_wt=str(self.label_40.text())
            self.tot_bags=str(self.lineEdit_16.text())
            self.AVG_bag_wt=int(self.net_wt)/int(self.tot_bags)
            self.label_49.setText(str("%d"%int(self.AVG_bag_wt)))
        
    def ontext_change2(self):
        #self.label_53.setText("11111")
        if(self.lineEdit_17.text() != ""):
            self.net_wt=str(self.label_40.text())
            self.AVG_bag_wt=str(self.lineEdit_17.text())
            self.tot_bags=int(self.net_wt)/int(self.AVG_bag_wt)
            self.label_53.setText(str("%d"%int(self.tot_bags)))
    ...
    def save_data(self):        
        ...
        if(len(self.vehicle_no) >= 4):
             ...
             print("self.first_wt_val :"+str(self.first_wt_val))
             if(str(self.label_46.text()) == "0"):
                ...
                if(int(self.first_wt_val) > 0):
                            ...
                            with connection:                            
                                ...
                                cursor.execute("INSERT INTO WEIGHT_MST(PARTY_NAME,SUPPLIER_NAME,TRANSPORT_NAME,MATERIAL_NAME,FIRST_WEIGHT_MODE,FIRST_WEIGHT_VAL,WEIGHT_TYPE,NET_WEIGHT_VAL,VEHICLE_NO,AMOUNT,PHONE_NO_1,PHONE_NO_2,PHONE_NO_3,FIRST_WT_CRTEATED_ON,TRANSPORT_TYPE,TOTAL_BAGS,AVG_BAG_WT,DRIVER_IN_OUT) VALUES('"+self.party_name+"','"+self.supplier_name+"','"+self.transport_name+"','"+self.materail_name+"','"+self.first_wt_mode+"','"+self.first_wt_val+"','"+self.weight_type+"','"+self.net_wt_val+"','"+self.vehicle_no+"','"+self.amount+"','"+str(self.lineEdit_12.text())+"','"+str(self.lineEdit_12_1.text())+"','"+str(self.lineEdit_12_2.text())+"','"+str(cr_date)+"','"+str(self.lineEdit_13.text())+"','"+str(self.tot_bags)+"','"+str(self.AVG_bag_wt)+"','"+str(self.driver_in_out)+"')")
                            connection.commit();
                            connection.close()
                            #print("Data Inserted !!!!")                            
                            self.label_3.show()                            
    ...
    def call_fetch_slip_via_vehicle(self):
        ...
        self.fetch_slip_data()
        #print("self.wt_type after call :"+str(self.wt_type))
    ...
    def fetch_slip_data(self):        
        ...
        for x in results:        
            ...
            #print("self.wt_type : insyde"+str(self.wt_type))
            if(str(x[16]) == "SECOND"):
               self.pushButton_9.setDisabled(True)
               self.pushButton_10.setDisabled(True)
               self.pushButton_5.setDisabled(True)
