...
"color: rgb(255, 0, 0);")
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(1200, 480, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
...
"color: rgb(255, 255, 255);")
        ...
        self.label_30.setGeometry(QtCore.QRect(1280, 600, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_31.setGeometry(QtCore.QRect(1280, 640, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_32.setGeometry(QtCore.QRect(1280, 680, 41, 21))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_25.setText(_translate("MainWindow", "Holding Time \n (Sec)"))
    ...
    def start_test_CYCLICK(self):
        ...
        if(self.goAhead=="Yes"):
               ...
               if(self.go_to_next==0):
                        ...
                        connection.commit();
                        connection.close()                            
                        self.label_21.setText("Itr No:"+str(self.itr_no[0])+"  Disp (mm):"+str(self.elongation_per[0])+" Time Sec :"+str(self.holding_time[0]))                        
    ...
    def start_test_CYCLICK2(self):
                if(self.go_to_next==1):
                        ...
                        connection.commit();
                        connection.close()
                        self.label_21.setText("ItrNo:"+str(self.itr_no[1])+"  Disp.(mm):"+str(self.elongation_per[1])+"  Time (Sec):"+str(self.holding_time[1]))                        
    ...
    def start_test_CYCLICK3(self):
                if(self.go_to_next==2):
                        ...
                        connection.commit();
                        connection.close()                            
                        self.label_21.setText("Itr No:"+str(self.itr_no[2])+"  Disp.(mm):"+str(self.elongation_per[2])+"  Time (Sec):"+str(self.holding_time[2]))                        
    ...
    def show_grid_data_CYCLICK(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['ITR.No.','Load (N)','Elongation (%) - Disp (mm)','Tensile \n Stress (N/mm2)','Shear Modulus \n (N/mm2)']) 
    ...
    def create_pdf_CYCLICK(self):
        ...
        for x in results:
            summary_data=[["Tested Date: ",str(x[10]),"Test No: ",str(x[0])],["Job Name : ",str(x[1]),"Batch ID: ",str(x[2])],["Specimen Name:  ",str(x[4]),"Specmen Shape:",str(x[9])],["Test Type:","CYCLIC","CS. AREA (mm2):",str(self.label_64.text())],["Party Name :",str(x[7]),"Test Speed (mm/min) :",str(x[5])],["Guage Length(mm):",str(x[6]),"Report Date: ",str(x[11])],["Tested By :", "","",""]]
