...
"")
        ...
        if( int(i) > -1):
            ...
            if(product_id != "ERROR"):
                            if(file_name==""):
                                ...
                                os.system("sudo cd  /home/pi/Products/ROLTA/reports")
                                print("sudo cp "+file_name+" /media/usb") 
                                os.system("sudo cp /home/pi/Products/ROLTA/reports/"+file_name+" /media/usb")                            
    ...
    def move_all(self):                   
        ...
        if(product_id != "ERROR"):                           
                                ...
                                os.system("sudo mount /dev/sda1 /media/usb -o uid=pi,gid=pi") 
                                os.system("sudo cd  /home/pi/Products/ROLTA/reports")                                
                                os.system("sudo cp /home/pi/Products/ROLTA/reports/*.pdf /media/usb")                            
                                os.system("sudo umount /media/usb")
                                #os.system("sudo mount /dev/sda1 /media/usb -o uid=pi,gid=pi")
                                self.label_2.show()
    ...
    def load_reports_files(self):
        try:
                    ...
                    try:
                       ...
                       for line in f:
                               line=line.replace("/home/pi/Products/ROLTA/reports/","")
                               ine=line.replace("\n","")
    ...
    def browse_file_onclick(self):
        ...
        if(product_id != "ERROR"):
                try:
                    ...
                    os.system("sudo mount /dev/sda1 /media/usb -o uid=pi,gid=pi")                    
                    os.system("sudo ls /media/usb/Report*.pdf >> backupfiles_list.txt")
                    os.system("sudo umount /media/usb")
                    try:
