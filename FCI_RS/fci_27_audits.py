...
class fci_27_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(100, 50, 113, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_10.clicked.connect( self.s_select_all_data)
        self.tableWidget.doubleClicked.connect(self.s_fetch_data_from_tw)
        
        self.radioButton_2.clicked.connect( self.date_range_onclick)
        self.radioButton.clicked.connect( self.all_records_onclick)
        
        self.pushButton_6.clicked.connect(self.from_on_click1)
        self.pushButton_7.clicked.connect(self.to_on_click2)
