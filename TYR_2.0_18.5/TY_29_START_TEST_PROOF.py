...
"color: rgb(255, 0, 0);")
        ...
        self.label_67.setGeometry(QtCore.QRect(850, 130, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.lineEdit_10.setGeometry(QtCore.QRect(450, 190, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_68.setGeometry(QtCore.QRect(570, 190, 51, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
...
" (Kgf) :"))
        ...
        self.label_25.setText(_translate("MainWindow", "Max.Length (mm)"))
...
" (mm) "))
    ...
    def show_grid_data_PROOF(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Spec.No.','Max.Load '+str(self.y_unit),'Max.Elongation '+str(self.x_unit),'Status','REC.NO '])  
