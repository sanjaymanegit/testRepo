...
"color: rgb(255, 0, 0);")
        ...
        self.label_6_2.setGeometry(QtCore.QRect(500, 110, 70, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        self.label_6_2.setFont(font)
        self.label_6_2.setText("0")
        self.label_6_2.setStyleSheet("color: rgb(170, 0, 127);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6_2.setText(_translate("MainWindow", ""))
    ...
    def show_baterry_status(self):
        try:
            ...
            print (RXData)
            line=str(RXData)        
            self.buff1=line.split("_")
            if(len(self.buff1)> 2):
                            if(str(self.buff1[4]) == 'R' or str(self.buff1[4]) == 'S'):
                                      if(int(self.buff1[3]) < 100)  :
    ...
    def start_test(self):         
        ...
        if(self.go_ahead =="Yes"):      
            ...
            self.timer3.start(1)
            if(self.start_plot.error_msg==""):
                self.label_5.setText("Running........")                
            else:
                self.label_5.setText(str(self.start_plot.error_msg))
            self.label_5.show()
        else:
    ...
    def show_progress_bar(self):
        ...
        if(len(self.start_plot.arr_p) > 0):
                ...
                self.label_6_2.setText(str(self.start_plot.bat_status))
...
class PlotCanvas_Auto(FigureCanvas):     
    ...
    def plot_auto(self):        
        ...
        try:
            ...
            print("IO Errors")
            self.error_msg="BlueTooth Error"
            self.IO_error_flg=1
