...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "TORQUE CALIBRATION"))
        ...
        self.label_41.setText(_translate("MainWindow", "LOAD (KG)"))
    ...
    def pre_calibration_steps(self):        
        ...
        self.lineEdit.show()
        self.label_44.show()
        self.label_44.setText("SET LOAD VALUE (e.g. 1.000)")
        self.frame_3.show()        
        try:
