...
"color: rgb(170, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "HP -  2000 ZZ"))
        self.radioButton.setText(_translate("MainWindow", "Normal Print Page"))
    ...
    def login_page(self):
        ...
        results=connection.execute("SELECT PWD FROM SERVICES_MST WHERE SERVICE_NAME = 'PRINTER_SETUP' AND STATUS = 'ACTIVE'") 
        for x in results:  
    ...
    def save_data(self):
        ...
        with connection:        
                ...
                cursor.execute("UPDATE DEVICE_CONF SET PRE_PRINT_FLAG = '"+str(self.pre_print)+"', PRINTER_NAME='"+str(self.comboBox.currentText())+"' ") 
        connection.commit();
        connection.close()
