...
class wt_22_Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(870, 395)
...
"color: rgb(170, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_19.setText(_translate("MainWindow", "WIFI Setting"))
    ...
    def login_system(self):
        ...
        results=connection.execute("SELECT PWD,xxx FROM SERVICES_MST WHERE SERVICE_NAME = 'WIFI_SETTING' AND STATUS = 'ACTIVE'") 
        for x in results:
            #print("key:"+str(x[1]))
            key=str(x[1])
            val=str(x[0])
