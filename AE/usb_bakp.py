...
"")
        ...
        if( int(i) > -1):
            ...
            if(product_id != "ERROR"):
                            if(file_name==""):
                                ...
                                os.system("sudo cd  ./reports")
                                print("sudo cp "+file_name+" /media/usb") 
                                os.system("sudo cp ./reports/"+file_name+" /media/usb")                            
    ...
    def move_all(self):                   
        ...
        if(product_id != "ERROR"):                           
                                ...
                                os.system("sudo mount /dev/sda1 /media/usb -o uid=pi,gid=pi") 
                                os.system("sudo cd  ./reports")                                
                                os.system("sudo cp ./reports/Report_of_test*.pdf /media/usb")                            
                                os.system("sudo umount /media/usb")
                                #os.system("sudo mount /dev/sda1 /media/usb -o uid=pi,gid=pi")
                                self.label_2.show()
    ...
    def load_reports_files(self):
        try:
                    ...
                    os.system("sudo ls ./reports/Report_of_test*.pdf >> report_files.txt")
                    #os.system("sudo cd")
                    try:
                       self.listWidget.clear() 
                       f = open('report_files.txt','r')
                       for line in f:
                               line=line.replace("./reports/","")
                               ine=line.replace("\n","")
