...
" Unit:"))
    ...
    def load_unit_on_change(self):
        ...
        load_unit_widgets = [self.label_22, self.label_63,self.label_41] 
        if (unit == "Kgf"):
...
#         self.sc_new.save_data_flg=""
    ...
    def save_graph_data(self):
        if (len(self.sc_new.arr_p) > 1):
            ...
            with connection:
                    cursor = connection.cursor() 
                    cursor.execute("INSERT INTO GRAPH_MST(X_NUM,X_NUM_CM,X_NUM_INCH,Y_NUM,Y_NUM_N,Y_NUM_MPA,Y_NUM_LB,Y_NUM_KN,T_SEC,UNIT_TYPE) SELECT X_NUM,X_NUM_CM,X_NUM_INCH,Y_NUM,Y_NUM_N,Y_NUM_MPA,Y_NUM_LB,Y_NUM_KN,T_SEC,UNIT_TYPE FROM STG_GRAPH_MST")
                    ...
                    if(int(str(self.comboBox.currentText())) == 2) :
                            ...
                            if(str(self.comboBox_2.currentText()) == "Kgf"):
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L1= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_92.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                            else:
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L1= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_92.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                          
                    elif(int(str(self.comboBox.currentText())) == 3):
                            cursor.execute("INSERT INTO TEST_DATA_RADIAL(TEST_ID,SPEC_ID,LOAD_POINTS,D1,D2,D3,LOAD_UNIT) VALUES ('"+str(int(self.label_12.text()))+"','"+str(self.cycle_num)+"','"+str(self.comboBox.currentText())+"','"+str(self.label_92.text())+"','"+str(self.label_93.text())+"','"+str(self.label_96.text())+"','"+str(self.comboBox_2.currentText())+"')")
                            if(str(self.comboBox_2.currentText()) == "Kgf"):
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L1= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_92.text())+"') ORDER BY REC_ID DESC LIMIT 1 ) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L3= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_96.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                            else:
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L1= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_92.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                    cursor.execute("UPDATE TEST_DATA_RADIAL SET L3= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_96.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                            ...
                            try:
                                ...
                                if(str(self.comboBox_2.currentText()) == "Kgf"):
                                        ...
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L3= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_96.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L4= (SELECT (Y_NUM) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_99.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        print("data Saved : 4")
                                else:
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L1= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_92.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L2= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_93.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L3= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_96.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                                        cursor.execute("UPDATE TEST_DATA_RADIAL SET L4= (SELECT (Y_NUM_N) from STG_GRAPH_MST WHERE UNIT_TYPE='R' AND X_NUM <= ('"+str(self.label_99.text())+"') ORDER BY REC_ID DESC LIMIT 1) WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
                    ...
                    try:
                        ...
                        if(str(self.comboBox_2.currentText()) == "Kgf"):
                                ...
                                cursor.execute("UPDATE TEST_DATA_RADIAL SET MAX_LOAD=(SELECT MAX(Y_NUM_N) from STG_GRAPH_MST),MAX_LENGTH=(SELECT MAX(X_NUM) from STG_GRAPH_MST),LOAD_UNIT='"+str(self.comboBox_2.currentText())+"',LENGTH_UNIT='"+str(self.comboBox_3.currentText())+"' WHERE TEST_ID = '"+str(int(self.label_12.text()))+"' and SPEC_ID='"+str(self.cycle_num)+"' and LOAD_POINTS='"+str(self.comboBox.currentText())+"'")
    ...
    def open_manual_control(self):
        ...
        with connection:        
                    cursor = connection.cursor()                
                    cursor.execute("update global_var set PRE_LOAD='"+str(self.lineEdit_11.text())+"',NEW_TEST_GUAGE_MM='"+str(self.lineEdit_17.text())+"'")                 
        connection.commit()
        connection.close()
        self.window = QtWidgets.QMainWindow()
