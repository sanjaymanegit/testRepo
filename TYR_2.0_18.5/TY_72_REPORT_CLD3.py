...
class TY_72_Ui_MainWindow(object):
...
#         self.sc_new.save_data_flg=""
    ...
    def delete_cycle(self):
            ...
            if(int(self.cycle_id) > 0):
                ...
                if close == QMessageBox.Yes:
                    ...
                    connection = sqlite3.connect("tyr.db")
                    results=connection.execute("select IFNULL(CYCLE_NUM,0),TEST_ID,IFNULL(GRAPH_ID,0) from CYCLES_MST where CYCLE_ID = '"+self.cycle_id+"'")                 
                    for x in results:
    ...
    def create_pdf_Tear(self):
        ...
        data2= [ ['Spec. \n No', 'Load @ '+str(self.disp_2)+' mm Guage\n ('+str(self.last_load_unit)+')']]
