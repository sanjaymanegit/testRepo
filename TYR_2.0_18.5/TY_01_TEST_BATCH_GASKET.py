...
from TY_02_START_TEST_2_GASKET import TY_02_Ui_MainWindow_GASKET
#from TY_01_TEST_BATCH_FLEXU import TY_02f_Ui_MainWindow
import sqlite3
from PyQt5.QtCore import QRegExp
from PyQt5.QtGui import QRegExpValidator

class TY_01_Ui_MainWindow_GASEKET(object):
    ...
    def open_window(self): 
        ...
        if(self.goAhead=="Yes"):        
            ...
            if(self.test_type=='Flexural'):
                    ...
                    self.ui=TY_02_Ui_MainWindow_GASKET()
...
if __name__ == "__main__":
    ...
    ui = TY_01_Ui_MainWindow_GASEKET()
