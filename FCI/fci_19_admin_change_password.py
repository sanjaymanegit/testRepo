...
# Form implementation generated from reading ui file 'fci_19_admin_change_password.ui'
#
...
"color: rgb(170, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(1, _translate("MainWindow", "Change Password"))
        self.comboBox.setItemText(2, _translate("MainWindow", "Date-Time Setting"))
        self.comboBox.setItemText(3, _translate("MainWindow", "API Config"))
        self.comboBox.setItemText(4, _translate("MainWindow", "Printer Setup"))
