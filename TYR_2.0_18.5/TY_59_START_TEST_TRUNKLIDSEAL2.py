...
"border-width:4px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "TRUNKLIDSEAL_CLD2"))
...
#         self.comboBox_2.setItemText(4, _translate("MainWindow", "Lb"))
        ...
        self.label_25.setText(_translate("MainWindow", "@Guage Length2 :"))
...
#         self.sc_new.save_data_flg=""
    ...
    def delete_cycle(self):       
            ...
            self.cycle_id=str(self.tableWidget.item(row, 2).text())
