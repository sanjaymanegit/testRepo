...
class fci_48_Ui_MainWindow(object):
    ...
    def select_all_data(self):     
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Slip No.','Party Name','Vehicle No.','Material','Net.Wt','First Weight Type','First Weight','First Weight On','Second Weight Type','Second Weight','Second Weight On'])        
