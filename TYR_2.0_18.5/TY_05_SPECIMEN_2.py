...
"background-color: rgb(226, 239, 255);")
        ...
        self.textBrowser.setGeometry(QtCore.QRect(1110, 240, 161, 81))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
...
"background-color: rgb(226, 239, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Product Width \\n (mm)"))
        ...
        self.comboBox_2.setItemText(3, _translate("MainWindow", "Direct Value"))
